...
- Make Marty Core dependency automation review-only: resolve a published stable
...
- Require stable Verifier tags to be new annotated tags prepared from one exact
  ...
  complete application version state, tag object, and source commit before any
  artifact is published; failed tags remain immutable and quarantined.
...
- Update CHANGELOG.md ([c19eef4](c19eef4406c3ac6a71e7e87dee3ea05e97534e7d))
- Update CHANGELOG.md ([d86a21f](d86a21f72906865fc22be17216a1fe0a1f9c4faf))
- Update CHANGELOG.md ([cc507db](cc507db9343763312d9de694e1273f9f78f62895))
...
- **deps**: Use marty-core v0.1.1 release ([69514cc](69514ccafa646ad91adc8ad7d1791829788bfe95))
...
- Use license-free publication secret scan ([8108ef9](8108ef92eccf8728eb168df7567436fb8b6f70ee))
- Allow verifier test reruns ([b19ffae](b19ffaeb72c55edb38818118cf0813a1b00903e0))
...
### Added
- Initial release of marty-verifier desktop application
- Document verification capabilities (eMRTD, mDL, badges)
- License management and validation
- Trust anchor synchronization
- Biometric liveness detection integration
